...
const ordersConfig: ResourceConfig = {
  ...
  sortableFields: ['createdAt', 'businessDate', 'orderNumber', 'customerName', 'grandTotal', 'status', 'branchName'],
...
const productionOrdersConfig: ResourceConfig = {
  ...
  sortableFields: ['businessDate', 'submittedAt', 'createdAt', 'demandNumber', 'branchName', 'status', 'requiredDate'],
...
const productsConfig: ResourceConfig = {
  ...
  sortableFields: ['name', 'sku', 'stockCode', 'categoryName', 'price', 'createdAt', 'updatedAt'],
